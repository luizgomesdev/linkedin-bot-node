            ...
            while (metrics.processed < query.options.limit) {
                ...
                while (jobIndex < jobsTot && metrics.processed < query.options.limit) {
                    ...
                    try {
                        ...
                        // Promoted job
                        if (((_b = query.options) === null || _b === void 0 ? void 0 : _b.skipPromotedJobs) && jobIsPromoted) {
                        ...
                        if ((_c = query.options) === null || _c === void 0 ? void 0 : _c.descriptionFn) {
                        ...
                        // Apply link
                        if ((_d = query.options) === null || _d === void 0 ? void 0 : _d.applyLink) {
                            const applyLinkRes = yield AuthenticatedStrategy._extractApplyLink(page, cdpSession, tag);
