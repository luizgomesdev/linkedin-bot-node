...
class AnonymousStrategy extends RunStrategy_1.RunStrategy {
    constructor() {
        ...
        this.run = (browser, page, cdpSession, url, query, location) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ((yield AnonymousStrategy._needsAuthentication(page))) {
            ...
            while (processed < query.options.limit) {
                yield AnonymousStrategy._acceptCookies(page, tag);
                ...
                while (jobIndex < jobsTot && processed < query.options.limit) {
                    ...
                    try {
                        ...
                        loadJobDetailsResult = yield AnonymousStrategy._loadJobDetails(page, jobId);
                ...
                const loadMoreJobsResult = yield AnonymousStrategy._loadMoreJobs(page, jobsTot);
